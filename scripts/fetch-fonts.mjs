...
const CSS_OUT = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '../src/styles/fonts.css')
const UA =
...
const WEIGHT_RANGE = { Inter: '400 600', Syne: '700 800' }
...
const faces = [...seen.values()].sort(
  (a, b) =>
    a.family.localeCompare(b.family) || KEEP.indexOf(a.subset) - KEEP.indexOf(b.subset)
)
...
const header = `/* Polices self-hostées — Inter & Syne (Google Fonts, licence SIL Open Font License 1.1).\n   Fichiers variables, sous-ensembles latin + latin-ext uniquement.\n   Aucune requête vers un domaine tiers au runtime. */\n\n`
...
// Rappel : public/fonts/LICENSE.txt (SIL OFL 1.1) doit accompagner les fichiers
// woff2 redistribués. Le régénérer depuis github.com/google/fonts si les
// familles changent.
